...
const sidebar = ref()
const links = [{title: 'صندوق',url: '/',img: chasierIcon},{title: 'انبارداری',url: '/warehouse',img: storageIcon},{title: 'آمار',url: '/status',img: statusIcon}]
  ...
  <div class="fixed top-0 bg-slate-50 w-full shadow-[0px_3px_5px_#c9c9c9] z-10">
    ...
    <div class="flex justify-start items-center gap-3 py-5 px-8">
      <button @click="handleDropdown" class="p-2 border rounded hover:border-blue-500">
        <svg v-if="!state.sidebar" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4 6H20M4 12H20M4 18H20" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <svg v-else width="20" height="20" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 21.32L21 3.32001" stroke="currentcolor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M3 3.32001L21 21.32" stroke="currentcolor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </button>
      <span class="font-bold text-[20px]">دفتر حسابها</span>
    </div>

    <div class="absolute top-20 -right-[100vw] w-full md:w-[50%] lg:w-[200px] h-screen transition-all ease-in-out duration-300" ref="sidebar" @click="handleDropdown">
